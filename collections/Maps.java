...
public class Maps {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(languages.put("Lisp", "LISt processing language"));
        ...
        // languages.remove("BASIC", "Beginners All Purposes Symbolic Instruction
        // Code");
        ...
        languages.replace("Lisp", "This will work");
